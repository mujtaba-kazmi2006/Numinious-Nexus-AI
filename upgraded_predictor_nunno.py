...
AI_API_KEY = "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"
...
def handle_question(prompt):
    ...
    def prediction_thread_func():
        ...
        try:
            ...
            analyzer = betterpridictormodule.TradingAnalyzer()
            try:
            ...
            if not stop_flag:
                ...
                betterpridictormodule.generate_trading_plan(confluences, latest_row, bias, strength)
